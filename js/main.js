...
(function() {
  var $canvas, ctx, current_H, current_L, current_S, hslToHex, hslToRgb, randomHue, redraw, redrawSwatch;
  ...
  redrawSwatch = (function() {
    var $channels, $hex, $scope, $swatch, c, chromaFromHex, conv, _i, _len, _ref;
